    ...
    <div class="main-panel">
        <div class="content">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h2 class="text-white pb-2">Welcome back, Users!</h2>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex">
                                    <div class="avatar">
                                        <img src="{{ asset('template-dashboard') }}/assets/img/logoproduct.svg"
                                ...
                                <div class="d-flex">
                                    <div class="avatar">
                                        <img src="{{ asset('template-dashboard') }}/assets/img/logoproduct3.svg"
                                            alt="{{ asset('template-dashboard') }}." class="avatar-img rounded-circle">
                                    </div>
                                    <div class="flex-1 pt-1 ml-2">
